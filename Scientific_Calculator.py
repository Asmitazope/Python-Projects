...
frame=tk.Frame(master=window,bg="skyblue",padx=30)
frame.pack()
entry=tk.Entry(master=frame,borderwidth=3,width=50,)
...
button_percent=tk.Button(master=frame,text='%',padx=15,pady=5,width=3,command=lambda:myclick('%'))
button_percent.grid(row=1,column=0,pady=1)

button_square=tk.Button(master=frame,text='x²',padx=15,pady=5,width=3,command=lambda:myclick('**2'))
button_square.grid(row=1,column=1,pady=1)

button_sqrt=tk.Button(master=frame,text='√x2',padx=15,pady=5,width=3,command=lambda:myclick('**0.5'))
button_sqrt.grid(row=1,column=2,pady=1)
